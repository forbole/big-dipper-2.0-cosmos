...
export { default as MsgMint } from '@/models/msg/asset/msg_mint';
export { default as MsgBurn } from '@/models/msg/asset/msg_burn';
export { default as MsgFreeze } from '@/models/msg/asset/msg_freeze';
export { default as MsgUnfreeze } from '@/models/msg/asset/msg_unfreeze';
