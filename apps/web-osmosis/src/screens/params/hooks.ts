...
const formatMint = (data: ParamsQuery) => {
  if (data.mintParams.length) {
    ...
    return {
      ...
      reductionFactor: mintParamsRaw.reductionFactor,
      genesisEpochProvisions: mintParamsRaw.genesisEpochProvisions,
      reductionPeriodInEpochs: mintParamsRaw.reductionPeriodInEpochs,
      mintingRewardsDistributionStartEpoch: mintParamsRaw.mintingRewardsDistributionStartEpoch,
