...
import type DesktopType from '@/screens/account_details/components/nfts/components/list/components/desktop';
import type MobileType from '@/screens/account_details/components/nfts/components/list/components/mobile';
