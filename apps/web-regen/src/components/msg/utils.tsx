...
import type { Categories } from '@models/regen/msg/types';
...
const customTypeToModel = {
  ...
  '/regen.group.v1alpha1.MsgCreateGroupAccountRequest': {
    ...
    content: CreateGroupAccountRequest,
    tagTheme: 'eight',
  ...
  '/regen.group.v1alpha1.MsgUpdateGroupAccountAdminRequest': {
    ...
    content: UpdateGroupAccountAdminRequest,
    tagTheme: 'eight',
  ...
  '/regen.group.v1alpha1.MsgUpdateGroupAccountDecisionPolicyRequest': {
    ...
    content: UpdateGroupAccountDecisionPolicyRequest,
    tagTheme: 'eight',
  ...
  '/regen.group.v1alpha1.MsgUpdateGroupAccountMetadataRequest': {
    ...
    content: UpdateGroupAccountMetadataRequest,
    tagTheme: 'eight',
  ...
  '/regen.group.v1alpha1.MsgUpdateGroupAdminRequest': {
    ...
    content: UpdateGroupAdminRequest,
    tagTheme: 'eight',
  ...
  '/regen.group.v1alpha1.MsgUpdateGroupMembersRequest': {
    ...
    content: UpdateGroupMembersRequest,
    tagTheme: 'eight',
  ...
  '/regen.group.v1alpha1.MsgUpdateGroupMetadataRequest': {
    ...
    content: UpdateGroupMetadataRequest,
    tagTheme: 'eight',
